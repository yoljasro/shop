...
if ( ! class_exists( 'SPF_WPSP_Field_typography' ) ) {
	...
	class SPF_WPSP_Field_typography extends SPF_WPSP_Fields {
		...
		public function render() {
			...
			// echo '<div class="spwps--input-wrap">';
			// echo '<input type="number" name="' . esc_attr( $this->field_name( '[word-spacing]' ) ) . '" class="spwps--word-spacing spwps--input spwps-input-number" value="' . esc_attr( $this->value['word-spacing'] ) . '" step="any" />';
			// echo '<span class="spwps--unit">' . esc_attr( $args['unit'] ) . '</span>';
			// echo '</div>';
			// echo '</div>';
			// }
			...
			// echo '<div class="spwps--toggle fa fa-toggle-off"></div>';
