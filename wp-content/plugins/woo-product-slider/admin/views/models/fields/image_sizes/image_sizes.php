		...
		public function render() {
			...
			if ( ! empty( $sizes ) ) {
				...
				if ( ! empty( $sizes ) ) {
					...
					echo '<select name="' . esc_attr( $this->field_name( $multiple_name ) ) . '"' . esc_attr( $multiple_attr ) . esc_attr( $chosen_attr ) . ' data-placeholder="' . esc_attr( $placeholder_attr ) . '"' . $this->field_attributes() . '>';
